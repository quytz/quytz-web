...
export const DICTIONARIES = {
  ...
  en: {
    ...
    whyApiKeyPopupTitle: "About Google AI Studio API Key",
    whatIsApiKeyTitle: "1. What is an API Key?",
    whatIsApiKeyAnswer: "A Google AI Studio API key is a unique encrypted string issued by Google. It acts as a digital key or secure password that allows external applications and websites to authenticate and communicate directly with Gemini AI brains. Never share your key publicly to protect your usage quota.",
    whyApiKeyTitle: "2. Why is personal API Key configuration required?",
