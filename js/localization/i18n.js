...
export const DICTIONARIES = {
  vi: {
    ...
    modelFixedNote: "Tự động kết nối Gemini 2.5 Flash / 1.5 Flash cho độ chính xác cao.",
  ...
  en: {
    ...
    modelLabel: "AI Model",
    modelFixedNote: "Auto-connected to Gemini 2.5 Flash / 1.5 Flash for high accuracy.",
    ...
    onlyInLLProjectNotice: "⚠️ Language Learning mode only applies to 'Language Learning Projects'. Please select or create a Language Project.",
    onlyInGeneralProjectNotice: "⚠️ General lecture scanning only applies to 'General Study Projects'. Please select or create a General Project.",
